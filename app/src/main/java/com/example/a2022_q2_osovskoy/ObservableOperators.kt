...
object ObservableOperators {
    ...
    object Task2 {
         ...
         * Успешно завершить передачу данных.
         */
        fun solve(): Observable<String> = Observable.just("Понедельник",
            "Вторник",
            "Среда",
            "Четверг",
            "Пятница",
    ...
    object Task4 {
        ...
        fun solve(): Observable<Int> =
            Observable.fromIterable(5 downTo 1).doOnComplete { error("Boom") }
    }
    ...
    object Task11 {
         ...
         */
        fun solve(source: Observable<Int>): Observable<Int> = source.map { value -> value + 1 }
    }
    ...
    object Task16 {
        ...
        fun solve(first: Observable<Int>, second: Observable<Int>): Observable<Int> =
            first.zipWith(second) { firstNum, secondNum -> firstNum + secondNum }
    }
